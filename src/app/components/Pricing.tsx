...
const quickPrices = [
  { id: "proefles", label: "Proefles + advies", price: "€ 65,-" },
  { id: "losse-les-60", label: "Losse les (60 min.)", price: "€ 75,-" },
  { id: "losse-les-90", label: "Losse les (90 min.)", price: "€ 112,50" },
];
...
const tabs = [
  {
    ...
    label: "Autorijlessen",
    items: [
      { name: "Proefles + advies*", price: "€ 65,-" },
      { name: "Losse les (60 min.)", price: "€ 75,-" },
      { name: "Losse les (90 min.)", price: "€ 112,50" },
    ],
  ...
  },
  {
    ...
    label: "Pakketten",
    items: [
      { name: "30 uur les incl. TTT + praktijkexamen", price: "€ 2.765,-", note: "€ 85,- korting" },
      { name: "35 uur les incl. TTT + praktijkexamen", price: "€ 3.135,-", note: "€ 90,- korting" },
      { name: "40 uur les incl. TTT + praktijkexamen", price: "€ 3.505,-", note: "€ 95,- korting" },
      { name: "Dagcursus BE (6 uur les + praktijkexamen)", price: "€ 750,-", note: "€ 50,- korting" },
    ],
  ...
  },
  {
    ...
    label: "Examens",
    items: [
      { name: "Praktijkexamen B", price: "€ 320,-" },
      { name: "Tussentijdse toets (TTT)", price: "€ 280,-" },
      { name: "Faalangstexamen B", price: "€ 340,-" },
      { name: "BNOR examen", price: "€ 340,-" },
    ],
  },
  {
    id: "aanhanger",
    label: "Aanhanger BE",
    items: [
      { name: "Dagcursus BE (6 uur les + praktijkexamen)", price: "€ 750,-" },
      { name: "Losse les (60 min.)", price: "€ 80,-" },
      { name: "Praktijkexamen BE", price: "€ 320,-" },
    ],
  },
];
