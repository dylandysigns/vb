...
const faqs = [
  ...
  { question: "Kan ik ook in de avond of op zaterdag lessen?", answer: "Ja, wij bieden flexibele lestijden aan. Je kunt ook 's avonds en op zaterdag rijlessen volgen. Zo combineer je rijlessen makkelijk met school, studie of werk." },
  { question: "Hebben jullie ook opfrislessen?", answer: "Zeker! Onze opfrislessen zijn ideaal als je al een rijbewijs hebt maar een tijdje niet hebt gereden. We helpen je om weer veilig en zelfverzekerd de weg op te gaan." },
