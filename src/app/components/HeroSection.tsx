        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal delay={550}>
              <div className="flex flex-wrap items-center gap-6 text-white/60 text-sm" style={{ fontFamily: body }}>
                <div className="flex items-center gap-2.5 bg-white/5 px-4 py-2 rounded-full">
                  ...
                  <span style={{ fontWeight: 500 }}>5.0/5 op Google</span>
                </div>
                <div className="flex items-center gap-2.5 bg-white/5 px-4 py-2 rounded-full">
                  <svg className="w-4 h-4 text-[#FD9F26]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span style={{ fontWeight: 500 }}>CBR erkend</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal direction="right" delay={400} distance={60}>
            <div className="relative z-10 hidden lg:block">
              ...
              {/* Floating card */}
              <div
                className="absolute -bottom-5 -left-5 bg-white rounded-2xl p-5 shadow-2xl transition-transform duration-500 hover:-translate-y-1"
                style={{ animation: "float 6s ease-in-out infinite" }}
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#FD9F26] to-[#FD9F26] rounded-xl flex items-center justify-center shadow-lg shadow-[#FD9F26]/20">
                    <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-gray-900" style={{ fontFamily: heading, fontWeight: 700, fontSize: "0.95rem" }}>Flexibele lestijden</p>
                    <p className="text-gray-500" style={{ fontFamily: body, fontWeight: 400, fontSize: "0.8rem" }}>Ook 's avonds en op zaterdag</p>
                  </div>
                </div>
              </div>
              ...
              <div
                className="absolute -top-3 -right-3 bg-white rounded-2xl p-4 shadow-2xl transition-transform duration-500 hover:-translate-y-1"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-900 text-sm" style={{ fontFamily: heading, fontWeight: 700 }}>Hoog slagingspercentage</p>
                  </div>
                </div>
              </div>
            </div>
